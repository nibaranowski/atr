...
import { getAllCompanysByUserId } from '../../../actions/companyActions';
...
class Companys extends Component {
  componentDidMount() {
    if (this.props.match.params.user_id) {
      this.props.getAllCompanysByUserId(this.props.match.params.user_id);
...
export default connect(mapStateToProps, { getAllCompanysByUserId })(Companys);
